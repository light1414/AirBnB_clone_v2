...
class TestCity(unittest.TestCase):
    ...
    def test_state_relationship_deletes(self):
        """This test delete cascade in City-State relationship."""
    ...
    def test_is_subclass(self):
        """City is a subclass of BaseModel check."""
    ...
    def test_two_models_are_unique(self):
        """this Test that different City instances are unique."""
        ct = City()
    ...
    def test_init_args_kwargs(self):
        """this Test initialization with args and kwargs."""
        dt = datetime.utcnow()
    ...
    def test_save_filestorage(self):
        """the test save method with FileStorage."""
    ...
    def test_save_dbstorage(self):
        """The test save method with DBStorage."""
        old = self.city.updated_at
        self.state.save()
        self.city.save()
        self.assertLess(old, self.city.updated_at)
